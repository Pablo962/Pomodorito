...
export default function Timer() {
  // Traemos todas las funciones y estados del hook
  const {
    isActive, 
    mode, 
    isFullscreen, 
    config, 
    pomodorosCompleted, // El contador de ciclos
    toggleTimer, 
    resetTimer, 
    updateConfig, 
    toggleFullscreen, 
    ...
    <div className={styles.container}>
      ...
      <div className={styles.header}>
        <span className={styles.statusBadge}>
          ...
          <span style={{ opacity: 0.6, marginLeft: '8px', fontSize: '1em' }}>
            #{pomodorosCompleted}
          </span>
        </span>
        ...
        <>
          ...
          <div className={styles.progressBar}>
            <div 
              ...
              style={{ 
                width: `${progress}%`,
                background: mode === 'focus' ? '#4ade80' : '#60a5fa' 
              }} 
            />
          </div>
          ...
          <div className={styles.controls}>
            <button 
              onClick={toggleTimer} 
              className={`${styles.mainButton} ${isActive ? styles.pauseBtn : styles.startBtn}`}
            >
            ...
            <button 
              onClick={skipPhase} 
              className={styles.secondaryBtn} 
              title="Saltar turno (ir a descanso/enfoque)"
            >
              ⏭
            </button>
          </div>
